...
const noAnswerMethod = () => {
    ...
    noBtn.style.left = xPosition >= wrapper.clientWidth / 2 ?  `${xPosition - noBtn.clientWidth}` : `${xPosition}px`;
    noBtn.style.top =yPosition >= wrapper.clientHeight / 2 ?  `${yPosition - noBtn.clientHeight}` : `${yPosition}px`  ;
